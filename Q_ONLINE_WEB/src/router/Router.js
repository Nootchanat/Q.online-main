...
import MainOpenSchdule from '../view/private/OpenSchedule/MainOpenSchdule';
import FormSchedule from '../view/private/OpenSchedule/FormSchedule';
// public
        ...
        {role === 0 ? (
          ...
          <PrivateLayout>
            <Routes>
              ...
              <Route path="/admin/open_schedule" element={< MainOpenSchdule/>} />
              <Route path="/admin/open_schedule/form" element={< FormSchedule/>} />
